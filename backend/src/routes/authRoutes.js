...
import { login, logout, me, register, resetPassword, updateOnboarding, updatePassword, updateProfile } from '../controllers/authController.js';
...
router.patch('/me/onboarding', authMiddleware, asyncHandler(updateOnboarding));
